...
export const BottomNavigation: React.FC<BottomNavigationProps> = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 select-none">
      ...
      <nav className="w-full bg-app-surface border-t-2 border-app-theme backdrop-blur-xl flex items-center justify-around px-2 py-1.5 shadow-2xl bottom-nav-safe transition-colors duration-300">
