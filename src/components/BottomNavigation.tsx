  ...
  return (
    <nav className="fixed bottom-3 left-4 right-4 z-40 h-16 rounded-2xl border border-slate-800/80 bg-slate-900/75 backdrop-blur-lg flex items-center justify-around px-4 shadow-xl shadow-black/40">
      ...
      <button 
        ...
        className={`flex flex-col items-center justify-center w-16 h-12 rounded-xl transition-all ${activeTab === 'settings' ? 'text-indigo-400 scale-105 font-bold' : 'text-slate-500 hover:text-slate-300'}`}
      >
